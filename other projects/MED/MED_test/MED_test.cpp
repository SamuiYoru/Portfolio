...
int main(){
    ...
    char in_imgpath[] = "C:\\Users\\yuchi\\Downloads\\HM1_images_file\\house512.raw";
    char out_imgpath[] = ".\\house512_out.raw";
    char out_imgpath_big[] = ".\\house512_out_padding.raw";
    char out_imgpath_MED[] = ".\\house512_out_MED.raw";
    int size = H * W;
    int size2=(W+2)*(H+2);
    unsigned char* img = new unsigned char[size];
    unsigned char img_input[W][H];
    unsigned char img_input_big[W+2][H+2];//[直][橫]
    unsigned char img_output_MED[W][H];//[直][橫]
